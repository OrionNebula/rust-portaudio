...
fn bindgen_test_layout_PaVersionInfo() {
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<PaVersionInfo>())).versionMajor as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<PaVersionInfo>())).versionMinor as *const _ as usize },
        4usize,
        concat!(
            "Offset of field: ",
            stringify!(PaVersionInfo),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<PaVersionInfo>())).versionSubMinor as *const _ as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(PaVersionInfo),
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<PaVersionInfo>())).versionControlRevision as *const _ as usize
        },
        16usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<PaVersionInfo>())).versionText as *const _ as usize },
        24usize,
        concat!(
            "Offset of field: ",
            stringify!(PaVersionInfo),
...
pub mod PaErrorCode {
    ...
    pub const paNoError: Type = 0;
    pub const paNotInitialized: Type = -10000;
    pub const paUnanticipatedHostError: Type = -9999;
    pub const paInvalidChannelCount: Type = -9998;
    pub const paInvalidSampleRate: Type = -9997;
    pub const paInvalidDevice: Type = -9996;
    pub const paInvalidFlag: Type = -9995;
    pub const paSampleFormatNotSupported: Type = -9994;
    pub const paBadIODeviceCombination: Type = -9993;
    pub const paInsufficientMemory: Type = -9992;
    pub const paBufferTooBig: Type = -9991;
    pub const paBufferTooSmall: Type = -9990;
    pub const paNullCallback: Type = -9989;
    pub const paBadStreamPtr: Type = -9988;
    pub const paTimedOut: Type = -9987;
    pub const paInternalError: Type = -9986;
    pub const paDeviceUnavailable: Type = -9985;
    pub const paIncompatibleHostApiSpecificStreamInfo: Type = -9984;
    pub const paStreamIsStopped: Type = -9983;
    pub const paStreamIsNotStopped: Type = -9982;
    pub const paInputOverflowed: Type = -9981;
    pub const paOutputUnderflowed: Type = -9980;
    pub const paHostApiNotFound: Type = -9979;
    pub const paInvalidHostApi: Type = -9978;
    pub const paCanNotReadFromACallbackStream: Type = -9977;
    pub const paCanNotWriteToACallbackStream: Type = -9976;
    pub const paCanNotReadFromAnOutputOnlyStream: Type = -9975;
    pub const paCanNotWriteToAnInputOnlyStream: Type = -9974;
    pub const paIncompatibleStreamHostApi: Type = -9973;
    pub const paBadBufferPtr: Type = -9972;
}
extern "C" {
...
pub mod PaHostApiTypeId {
    ...
    pub const paInDevelopment: Type = 0;
    pub const paDirectSound: Type = 1;
    pub const paMME: Type = 2;
    pub const paASIO: Type = 3;
    pub const paSoundManager: Type = 4;
    pub const paCoreAudio: Type = 5;
    pub const paOSS: Type = 7;
    pub const paALSA: Type = 8;
    pub const paAL: Type = 9;
    pub const paBeOS: Type = 10;
    pub const paWDMKS: Type = 11;
    pub const paJACK: Type = 12;
    pub const paWASAPI: Type = 13;
    pub const paAudioScienceHPI: Type = 14;
}
...
pub struct PaHostApiInfo {
    ...
    pub type_: PaHostApiTypeId::Type,
...
fn bindgen_test_layout_PaHostApiInfo() {
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<PaHostApiInfo>())).structVersion as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<PaHostApiInfo>())).type_ as *const _ as usize },
        4usize,
        concat!(
            "Offset of field: ",
            stringify!(PaHostApiInfo),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<PaHostApiInfo>())).name as *const _ as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(PaHostApiInfo),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<PaHostApiInfo>())).deviceCount as *const _ as usize },
        16usize,
        concat!(
            "Offset of field: ",
            stringify!(PaHostApiInfo),
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<PaHostApiInfo>())).defaultInputDevice as *const _ as usize
        },
        20usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<PaHostApiInfo>())).defaultOutputDevice as *const _ as usize
        },
        24usize,
        concat!(
            "Offset of field: ",
...
extern "C" {
    ...
    pub fn Pa_HostApiTypeIdToHostApiIndex(type_: PaHostApiTypeId::Type) -> PaHostApiIndex;
}
extern "C" {
...
pub struct PaHostErrorInfo {
    ...
    pub hostApiType: PaHostApiTypeId::Type,
...
fn bindgen_test_layout_PaHostErrorInfo() {
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<PaHostErrorInfo>())).hostApiType as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<PaHostErrorInfo>())).errorCode as *const _ as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(PaHostErrorInfo),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<PaHostErrorInfo>())).errorText as *const _ as usize },
        16usize,
        concat!(
            "Offset of field: ",
            stringify!(PaHostErrorInfo),
...
fn bindgen_test_layout_PaDeviceInfo() {
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<PaDeviceInfo>())).structVersion as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<PaDeviceInfo>())).name as *const _ as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(PaDeviceInfo),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<PaDeviceInfo>())).hostApi as *const _ as usize },
        16usize,
        concat!(
            "Offset of field: ",
            stringify!(PaDeviceInfo),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<PaDeviceInfo>())).maxInputChannels as *const _ as usize },
        20usize,
        concat!(
            "Offset of field: ",
            stringify!(PaDeviceInfo),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<PaDeviceInfo>())).maxOutputChannels as *const _ as usize },
        24usize,
        concat!(
            "Offset of field: ",
            stringify!(PaDeviceInfo),
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<PaDeviceInfo>())).defaultLowInputLatency as *const _ as usize
        },
        32usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<PaDeviceInfo>())).defaultLowOutputLatency as *const _ as usize
        },
        40usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<PaDeviceInfo>())).defaultHighInputLatency as *const _ as usize
        },
        48usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<PaDeviceInfo>())).defaultHighOutputLatency as *const _ as usize
        },
        56usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<PaDeviceInfo>())).defaultSampleRate as *const _ as usize },
        64usize,
        concat!(
            "Offset of field: ",
            stringify!(PaDeviceInfo),
...
fn bindgen_test_layout_PaStreamParameters() {
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<PaStreamParameters>())).device as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<PaStreamParameters>())).channelCount as *const _ as usize },
        4usize,
        concat!(
            "Offset of field: ",
            stringify!(PaStreamParameters),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<PaStreamParameters>())).sampleFormat as *const _ as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(PaStreamParameters),
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<PaStreamParameters>())).suggestedLatency as *const _ as usize
        },
        16usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<PaStreamParameters>())).hostApiSpecificStreamInfo as *const _
                as usize
        },
        24usize,
        concat!(
...
fn bindgen_test_layout_PaStreamCallbackTimeInfo() {
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<PaStreamCallbackTimeInfo>())).inputBufferAdcTime as *const _
                as usize
        },
        0usize,
        concat!(
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<PaStreamCallbackTimeInfo>())).currentTime as *const _ as usize
        },
        8usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<PaStreamCallbackTimeInfo>())).outputBufferDacTime as *const _
                as usize
        },
        16usize,
        concat!(
...
pub mod PaStreamCallbackResult {
...
fn bindgen_test_layout_PaStreamInfo() {
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<PaStreamInfo>())).structVersion as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<PaStreamInfo>())).inputLatency as *const _ as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(PaStreamInfo),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<PaStreamInfo>())).outputLatency as *const _ as usize },
        16usize,
        concat!(
            "Offset of field: ",
            stringify!(PaStreamInfo),
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<PaStreamInfo>())).sampleRate as *const _ as usize },
        24usize,
        concat!(
            "Offset of field: ",
            stringify!(PaStreamInfo),
